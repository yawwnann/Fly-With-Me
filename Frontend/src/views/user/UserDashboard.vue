<template>
  ...
  <div class="min-h-screen flex flex-col items-center justify-start">
    ...
    <section class="w-full py-16 bg-gray-100 flex flex-col items-center" data-aos="fade-up">
      ...
      <!-- Loading State -->
      <div v-if="loadingPackages" class="flex flex-col items-center justify-center py-20">
        <div class="relative">
          <div class="w-16 h-16 border-4 border-blue-200 rounded-full animate-spin"></div>
          <div
            class="absolute top-0 left-0 w-16 h-16 border-4 border-blue-500 rounded-full animate-spin border-t-transparent"
          ></div>
        </div>
        <p class="mt-4 text-gray-600 font-medium">Memuat paket layanan...</p>
      </div>
    ...
    <section class="w-full py-20 bg-gray-100 relative overflow-hidden" data-aos="fade-up">
      ...
      <div class="container mx-auto px-4 relative z-10">
        ...
        <!-- Loading State -->
        <div v-if="loadingPortfolio" class="flex flex-col items-center justify-center py-20">
          <div class="relative">
            <div class="w-16 h-16 border-4 border-blue-200 rounded-full animate-spin"></div>
            <div
              class="absolute top-0 left-0 w-16 h-16 border-4 border-blue-500 rounded-full animate-spin border-t-transparent"
          ...
          <p class="mt-4 text-gray-600 font-medium">Memuat portfolio...</p>
        </div>
